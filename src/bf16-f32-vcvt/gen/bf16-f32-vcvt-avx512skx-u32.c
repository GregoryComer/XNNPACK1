...
void xnn_bf16_f32_vcvt_ukernel__avx512skx_u32(
    size_t batch,
    ...
    const void* params)
{
  ...
  for (; batch >= 32 * sizeof(xnn_bfloat16); batch -= 32 * sizeof(xnn_bfloat16)) {
    const __m512 vacc0 = _mm512_castsi512_ps(_mm512_slli_epi32(_mm512_cvtepu16_epi32(_mm256_loadu_si256((const __m256i*) i)), 16));
    const __m512 vacc1 = _mm512_castsi512_ps(_mm512_slli_epi32(_mm512_cvtepu16_epi32(_mm256_loadu_si256((const __m256i*) (i + 16))), 16));
    i += 32;
